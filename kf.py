...
# K-fuscator
# Author  : KasRoudra
# Github  : https://github.com/wak-vluks
# Contact : https://m.me/wak vluks
# Language: Python(3)
# Date    : 18-08-2021
...
def about():
    ...
    print(f"{cyan}[Author]    {purple} :[wakvluks]")
    print(f"{cyan}[Github]    {purple} :[https://github.com/wak-vluks]")
    print(f"{cyan}[Messenger] {purple} :[https://m.me/wak vluks]")
    print(f"{cyan}[Email]     {purple} :[wakvluks@gmail.com]\n")
...
def encryptsh():
    ...
    with open(".temp",'r') as temp_f, open(out_file,'w') as out_f:
        ...
        out_f.write("# Encrypted by K-fuscator\n# Github- https://github.com/wak-vluks/k-fuscator\n\n"+filedata)
    os.remove(".temp")
    ...
    while True:
        if choose == "1" or choose=="01":
            ...
            if os.path.exists("/data/data/com.termux/files/home"):
                os.system("xdg-open --view 'https://github.com/wak-vluks/wak-vluks#My-Best-Works'")
            else:
                os.system("xdg-open 'https://github.com/wak-vluks/wak-vluks#My-Best-Works'")
            main()
